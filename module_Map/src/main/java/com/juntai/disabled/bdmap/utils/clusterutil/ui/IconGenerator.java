...
package com.juntai.disabled.bdmap.utils.clusterutil.ui;
...
public class IconGenerator {
    ...
    public IconGenerator(Context context) {
        mContext = context;
        mContainer = (ViewGroup) LayoutInflater.from(mContext.getApplicationContext()).inflate(R.layout.text_bubble, null);
